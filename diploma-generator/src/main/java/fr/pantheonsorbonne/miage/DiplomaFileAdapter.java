...
public class DiplomaFileAdapter extends FileGenerator<AbstractDiplomaGenerator> {
	...
	@Override
	public void generateFile(String outputFile) throws FailedWritetException, FailedGenerateException {
		try (FileOutputStream fos = new FileOutputStream(outputFile)) {
			...
			e.printStackTrace();
			throw new FailedWritetException("failed to write diploma file");
		}
	}
