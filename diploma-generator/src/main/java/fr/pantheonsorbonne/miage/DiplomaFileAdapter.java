...
public class DiplomaFileAdapter extends FileGenerator<AbstractDiplomaGenerator> {
	...
	@Override
	public void generateFile(String outputFile) throws FailGenerateFileException, FailGenerateDocException, FailWriteDiplomaException {
		try (FileOutputStream fos = new FileOutputStream(outputFile)) {
			...
			throw new FailWriteDiplomaException();
		}
	}
