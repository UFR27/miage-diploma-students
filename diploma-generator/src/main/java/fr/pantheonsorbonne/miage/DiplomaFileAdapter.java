...
public class DiplomaFileAdapter extends FileGenerator<AbstractDiplomaGenerator> {
	...
	@Override
	public void generateFile(String outputFile) throws FailedToGenerateException, FailedToWriteDiplomaFileException {
		try (FileOutputStream fos = new FileOutputStream(outputFile)) {
			...
			e.printStackTrace();
			throw new FailedToWriteDiplomaFileException("failed to write diploma file");
