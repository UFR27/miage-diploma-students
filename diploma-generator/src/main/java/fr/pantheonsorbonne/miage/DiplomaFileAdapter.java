...
public class DiplomaFileAdapter extends FileGenerator<AbstractDiplomaGenerator> {
	...
	@Override
	public void generateFile(String outputFile) throws AbstractDiplomaGeneratorException, DiplomaFileAdapterException {
		try (FileOutputStream fos = new FileOutputStream(outputFile)) {
			...
			e.printStackTrace();
			throw new DiplomaFileAdapterException("failed to write diploma file", e);
		}
	}
