...
public class DiplomaFileAdapter extends FileGenerator<AbstractDiplomaGenerator> {
	...
	@Override
	public void generateFile(String outputFile) throws FailedToGenerateException, FailedToWriteDiplomaFile, FailedEncryption {
		try (FileOutputStream fos = new FileOutputStream(outputFile)) {
			...
			e.printStackTrace();
			throw new FailedToWriteDiplomaFile("failed to write diploma file");
