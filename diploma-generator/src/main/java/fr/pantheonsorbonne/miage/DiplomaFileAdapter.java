...
public class DiplomaFileAdapter extends FileGenerator<AbstractDiplomaGenerator> {
	...
	@Override
	public void generateFile(String outputFile)throws FailedToGenerateException, FailedToStreamException{
		try (FileOutputStream fos = new FileOutputStream(outputFile)) {
			...
			e.printStackTrace();
			throw new FailedToGenerateException("failed to write diploma file", e);
		}
	}
