...
public class EncryptedDiplomaGeneratorDecorator extends DiplomaGeneratorDecorator {
	...
	@Override
	public InputStream getContent() throws FailedToGenerateException, FailedToStreamException {
		...
		try (InputStream is = other.getContent()) {
			...
			e.printStackTrace();
			throw new FailedToGenerateException("failed to generate Encrypted File", e);
		}
