...
public abstract class AbstractDiplomaGenerator implements DiplomaGenerator {
	 ...
	 */
	@Override
	public InputStream getContent() throws FailException, FailGenerateDocumentException {
		...
		try (ByteArrayOutputStream bos = new ByteArrayOutputStream();) {
			...
			throw new FailException("failed to generate the file to stream to");
		}

	}

	protected void writeToStream(OutputStream os) throws FailGenerateDocumentException {
		...
		try {
			...
			throw new FailGenerateDocumentException("failed to generate Document");
		} finally {
			document.close();
		}
	}
