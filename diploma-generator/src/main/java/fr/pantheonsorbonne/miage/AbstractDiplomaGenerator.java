...
public abstract class AbstractDiplomaGenerator implements DiplomaGenerator {
	 ...
	 */
	@Override
	public InputStream getContent() throws FailedToGenerateException, FailedToGenerateDocException {
	...
	protected void writeToStream(OutputStream os) throws FailedToGenerateDocException {
		...
		try {
			...
			throw new FailedToGenerateDocException("failed to generate Document");
		} finally {
			document.close();
		}
	}
