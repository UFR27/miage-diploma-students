...
public abstract class AbstractDiplomaGenerator implements DiplomaGenerator {
	 ...
	 */
	@Override
    public InputStream getContent() throws FailedException {
        ...
        try (ByteArrayOutputStream bos = new ByteArrayOutputStream();) {
            ...
            throw new FailedException("failed to generate the file to stream to");
        }
	...
	protected void writeToStream(OutputStream os) throws FailedException {
		...
		try {
			...
			throw new FailedException("failed to generate Document");
		} finally {
			document.close();
		}
	}
