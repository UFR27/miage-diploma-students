...
public abstract class AbstractDiplomaGenerator implements DiplomaGenerator {
	 ...
	 */
	@Override
	public InputStream getContent() throws FileToStreamGenerationFailException, DocumentGenerationFailException {
		...
		try (ByteArrayOutputStream bos = new ByteArrayOutputStream();) {
			...
			throw new FileToStreamGenerationFailException("failed to generate the file to stream to", e);
		}

	}

	protected void writeToStream(OutputStream os) throws DocumentGenerationFailException {
		...
		try {
			...
			throw new DocumentGenerationFailException("failed to generate Document", e);
		} finally {
			document.close();
		}
	}
