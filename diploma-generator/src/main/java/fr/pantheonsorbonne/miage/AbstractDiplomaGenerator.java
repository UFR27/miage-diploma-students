...
public abstract class AbstractDiplomaGenerator implements DiplomaGenerator {
	 ...
	 */
	@Override
	public InputStream getContent() throws DiplomaGeneratorExcpetion {
		...
		try (ByteArrayOutputStream bos = new ByteArrayOutputStream();) {
			...
			throw new DiplomaGeneratorExcpetion("failed to generate the file to stream to", e);
		}

	}

	protected void writeToStream(OutputStream os) throws DiplomaGeneratorExcpetion {
		...
		try {
			...
			throw new DiplomaGeneratorExcpetion("failed to generate Document", e);
		} finally {
			document.close();
		}
	}
