...
public abstract class AbstractDiplomaGenerator implements DiplomaGenerator {
	 ...
	 */
	@Override
	public InputStream getContent() throws GenerationFileException{
		...
		try (ByteArrayOutputStream bos = new ByteArrayOutputStream();) {
			...
			throw new GenerationFileException("failed to generate the file to stream to", e);
		}

	}

	protected void writeToStream(OutputStream os) throws GenerationFileException {
		...
		try {
			...
			throw new GenerationFileException("failed to generate Document", e);
		} finally {
			document.close();
		}
	}
