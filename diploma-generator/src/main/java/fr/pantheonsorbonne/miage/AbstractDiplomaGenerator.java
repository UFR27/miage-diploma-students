...
public abstract class AbstractDiplomaGenerator implements DiplomaGenerator {
	...
	public InputStream getContent() throws AbstractDiplomaGeneratorException {
		...
		try (ByteArrayOutputStream bos = new ByteArrayOutputStream();) {
			...
			throw new AbstractDiplomaGeneratorException("failed to generate the file to stream to", e);
		}
	...
	protected void writeToStream(OutputStream os) throws AbstractDiplomaGeneratorException {
		...
		try {
			...
			throw new AbstractDiplomaGeneratorException("failed to generate Document", e);
		} finally {
			document.close();
		}
	}
