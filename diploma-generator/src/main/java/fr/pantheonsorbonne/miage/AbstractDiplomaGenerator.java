...
public abstract class AbstractDiplomaGenerator implements DiplomaGenerator {
	 ...
	 */
	@Override
	public InputStream getContent() throws FileGenerationException {
		...
		try (ByteArrayOutputStream bos = new ByteArrayOutputStream();) {
			...
			throw new FileGenerationException("failed to generate the file to stream to", e);
		}

	}

	protected void writeToStream(OutputStream os) throws FileGenerationException {
		...
		try {
			...
			throw new FileGenerationException("failed to generate Document", e);
		} finally {
			document.close();
		}
	}
