...
public abstract class AbstractDiplomaGenerator implements DiplomaGenerator {
	 ...
	 */
	@Override
	public InputStream getContent() throws FailInGenerateException, FailInGenerateDocumentException {
		...
		try (ByteArrayOutputStream bos = new ByteArrayOutputStream();) {
			...
			throw new FailInGenerateException("failed to generate the file to stream to");
		}
	}

	protected void writeToStream(OutputStream os) throws FailInGenerateDocumentException {
		...
		try {
			...
			throw new FailInGenerateDocumentException("failed to generate Document");
		} finally {
			document.close();
		}
	}
