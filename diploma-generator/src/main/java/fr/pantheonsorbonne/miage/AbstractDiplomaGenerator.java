...
public abstract class AbstractDiplomaGenerator implements DiplomaGenerator {
	 ...
	 */
	@Override
	public InputStream getContent() throws FileStreamException  {
		...
		try (ByteArrayOutputStream bos = new ByteArrayOutputStream();) {
			...
			throw new FileStreamException("failed to generate the file to stream to", e);
		}

	}

	protected void writeToStream(OutputStream os) throws FileStreamException {
		...
		try {
			...
			throw new FileStreamException("failed to generate Document", e);
		} finally {
			document.close();
		}
	}
