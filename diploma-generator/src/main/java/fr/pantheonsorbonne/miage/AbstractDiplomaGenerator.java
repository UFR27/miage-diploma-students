...
public abstract class AbstractDiplomaGenerator implements DiplomaGenerator {
	 ...
	 */
	@Override
	public InputStream getContent() throws DiplomaNotGeneratedException {
		...
		try (ByteArrayOutputStream bos = new ByteArrayOutputStream()) {
			...
			throw new DiplomaNotGeneratedException("failed to generate the file to stream to", e);
		}
	}

	protected void writeToStream(OutputStream os) throws DiplomaNotGeneratedException {
		...
		try {
			...
			throw new DiplomaNotGeneratedException("failed to generate Document", e);
