...
public abstract class AbstractDiplomaGenerator implements DiplomaGenerator {
	 ...
	 */
	@Override
	public InputStream getContent() throws FailedToGenerate {
		...
		try (ByteArrayOutputStream bos = new ByteArrayOutputStream();) {
			...
			throw new FailedToGenerate("failed to generate the file to stream to");
		}

	}

	protected void writeToStream(OutputStream os) throws FailedToGenerate {
		...
		try {
			...
			throw new FailedToGenerate("failed to generate Document");
		} finally {
			document.close();
		}
	}
