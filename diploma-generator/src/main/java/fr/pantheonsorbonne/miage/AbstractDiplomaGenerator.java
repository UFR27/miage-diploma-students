...
public abstract class AbstractDiplomaGenerator implements DiplomaGenerator {
	 ...
	 */
	@Override
	public InputStream getContent() throws Generror{
		...
		try (ByteArrayOutputStream bos = new ByteArrayOutputStream();) {
			...
			throw new Generror("failed to generate the file to stream to", e);
		}

	}

	protected void writeToStream(OutputStream os) throws Generror {
		...
		try {
			...
			throw new Generror("failed to generate Document", e);
		} finally {
			document.close();
		}
	}
