...
public abstract class AbstractDiplomaGenerator implements DiplomaGenerator {
	 ...
	 */
	@Override
	public InputStream getContent()throws FailedToStreamException, FailedToGenerateException{
		...
		try (ByteArrayOutputStream bos = new ByteArrayOutputStream();){
			...
			throw new FailedToStreamException("failed to generate the file to stream to", e);
		}
	...
	protected void writeToStream(OutputStream os) throws FailedToGenerateException {
		...
		try {
			...
			throw new FailedToGenerateException("failed to generate Document", e);
		} finally {
			document.close();
		}
	}
