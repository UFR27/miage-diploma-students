...
public abstract class AbstractDiplomaGenerator implements DiplomaGenerator {
	 ...
	 */
	@Override
	public InputStream getContent() throws FailGenerateFileException, FailGenerateDocException {
		...
		try (ByteArrayOutputStream bos = new ByteArrayOutputStream();) {
			...
			throw new FailGenerateFileException();
		}

	}

	protected void writeToStream(OutputStream os) throws FailGenerateDocException {
		...
		try {
			...
			throw new FailGenerateDocException();
		} finally {
			document.close();
		}
	}
