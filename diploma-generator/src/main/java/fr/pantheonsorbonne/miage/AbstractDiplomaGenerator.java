...
public abstract class AbstractDiplomaGenerator implements DiplomaGenerator {
	 ...
	 */
	@Override
	public InputStream getContent() throws MyOwnRuntimeException2 {
		...
		try (ByteArrayOutputStream bos = new ByteArrayOutputStream();) {
			...
			throw new MyOwnRuntimeException2("failed to generate the file to stream to", e);
		}

	}

	protected void writeToStream(OutputStream os) throws MyOwnRuntimeException2 {
		...
		try {
			...
			throw new MyOwnRuntimeException2("failed to generate Document", e);
		} finally {
			document.close();
		}
	}
