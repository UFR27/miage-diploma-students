...
public abstract class AbstractDiplomaGenerator implements DiplomaGenerator {
	 ...
	 */
	@Override
	public InputStream getContent() throws StreamException{
		...
		try (ByteArrayOutputStream bos = new ByteArrayOutputStream();) {
			...
			throw new StreamException("failed to generate the file to stream to", e);
		}

	}

	protected void writeToStream(OutputStream os) throws StreamException {
		...
		try {
			...
			throw new StreamException("failed to generate Document", e);
		} finally {
			document.close();
		}
	}
