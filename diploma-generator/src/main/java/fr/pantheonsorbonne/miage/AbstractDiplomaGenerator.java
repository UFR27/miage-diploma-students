...
public abstract class AbstractDiplomaGenerator implements DiplomaGenerator {
     ...
     */
    @Override
    public InputStream getContent() throws StreamFileException{
        ...
        try (ByteArrayOutputStream bos = new ByteArrayOutputStream();) {
            ...
            throw new StreamFileException("failed to generate the file to stream to", e);
        }

    }

    protected void writeToStream(OutputStream os) throws PoolDocumentException {
        ...
        try {
            ...
            throw new PoolDocumentException("failed to generate Document", e);
        } finally {
            document.close();
        }
    }
