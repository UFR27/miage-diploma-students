...
public class Main {
	...
	protected static void handleResponse(Response response, int studentId) throws IOException, FailGenerateFileException, FailGenerateDocException, FailGeEncryException {
