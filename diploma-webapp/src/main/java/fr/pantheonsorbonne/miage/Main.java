...
public class Main {
	...
	protected static void handleResponse(Response response, int studentId) throws IOException {
		...
		EncryptedDiplomaGeneratorDecorator encryptedGenerator = new EncryptedDiplomaGeneratorDecorator(generator, student.getPassword()); 
		try (InputStream is = encryptedGenerator.getContent()) {
