...
public class Main {
	...
	protected static void handleResponse(Response response, int studentId) throws IOException, FileGeneratorException {

		response.setContentType("application/pdf");

		Student student = getStudentData(studentId, studentRepo);

		EncryptedDiplomaGeneratorDecorator generator = new EncryptedDiplomaGeneratorDecorator(new MiageDiplomaGenerator(student),"ChristmasEvel");
