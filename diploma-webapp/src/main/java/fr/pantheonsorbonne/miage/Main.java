...
public class Main {
	...
	private static final String URI = "http://localhost:8080/home";
	...
	public static void main(String[] args) throws IOException, URISyntaxException {
...

		{
			...
			logger.severe("Press any key to stop the server...");
			System.in.read();
		} catch (Exception e) {
	...
	protected static void handleResponse(Response response, int studentId) throws IOException {
		...
		EncryptedDiplomaGeneratorDecorator egenerator = new EncryptedDiplomaGeneratorDecorator(generator, student.getPassword()); 
		
		try (InputStream is = egenerator.getContent()) {
